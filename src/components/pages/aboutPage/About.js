...
function About({cart, toggleCart, currency, currencyChar, onCurrencyChange, formattedAmount, }) {
    return (
        <div>
            ...
            <div className="about">
                <div className="container">
                    <article className="about-article">
                        ...
                        <p>Welcome to the world of perfect tea and coffee enjoyment with <strong>MugMate</strong> – a
                            unique
                            coaster that
                            ensures your beverage is always at the ideal drinking temperature. We understand how
                            important
                        ...
                        <p>The <strong>wooden</strong> parts are crafted with precision
                            ...
                            smoothness and perfect proportions for each item. We carefully select high-quality materials
                            to
                        ...
                        <p>One of the key features of <strong>MugMate</strong> is its functionality. You can connect it
                            to
                            your device by USB
                        ...
                        <p>For us, a cup of tea or coffee is not just a drink – it's an essential part of your day, a
                            ritual
                            that brings relaxation and pleasure. With <strong>MugMate</strong>, you’ll always know when
                            your
                            drink is ready
                            for that perfect sip. No more guessing – <strong>MugMate</strong> takes care of you, helping
                            you avoid drinks
                        ...
                        <p className="about-moment-slogan">Choose MugMate – and enjoy your drink at the perfect
                            moment!</p>
                    </article>
                </div>
            </div>
